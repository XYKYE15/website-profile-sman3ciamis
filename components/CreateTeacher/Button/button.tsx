...
import { handleDeleteTeacher } from "@/lib/actions";
...
export const SubmitTeacherButton = ({ label, cancelHref }: SubmitButtonProps) => {
...
// Tombol Edit
export const EditTeacherButton = ({ id }: { id: string }) => {
  return (
    <Link
...
// Tombol Delete
export const DeleteTeacherButton = ({ id }: { id: string }) => {
  return (
    <form action={handleDeleteTeacher} className="inline-block">
